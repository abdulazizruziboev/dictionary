  ...
  return (
    <header className="flex justify-center items-center outline-[#A445ED]">
        ...
        <a href="/" className="outline-[#A445ED]">
            <img src="/src/assets/imgs/logo.svg" className="h-[32px] w-[28px]"/>
        </a>
        ...
        <label className="flex gap-2 px-3 cursor-pointer mr-2" label="theme-toggler">
            ...
            />
            {!isDark&&<img src="/src/assets/imgs/moon.svg" className="h-[20px] w-[20px] cursor-pointer"/>}
            {isDark&&<img src="/src/assets/imgs/moon-dark.svg" className="h-[20px] w-[20px] cursor-pointer"/>}
        </label>
        </div>
        </div>
    </header>
